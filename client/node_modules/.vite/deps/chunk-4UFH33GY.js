import {
  ...
  useTheme
} from "./chunk-PMDQEVEH.js";
import {
  Transition_default
} from "./chunk-LMQYT3AI.js";
import {
  capitalize_default,
...
var SnackbarContent = React5.forwardRef(function SnackbarContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsxs)(SnackbarContentRoot, _extends({
    role,
    square: true,
    elevation: 6,
    className: clsx_default(classes.root, className),
    ...
    children: [(0, import_jsx_runtime4.jsx)(SnackbarContentMessage, {
      className: classes.message,
      ownerState,
      children: message
    }), action ? (0, import_jsx_runtime4.jsx)(SnackbarContentAction, {
...
var Snackbar = React6.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(ClickAwayListener, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
    children: (0, import_jsx_runtime6.jsx)(SnackbarRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime6.jsx)(TransitionComponent, _extends({
        ...
        children: children || (0, import_jsx_runtime6.jsx)(SnackbarContent_default, _extends({
          message,
          action
        }, ContentProps))
      }))
...
//# sourceMappingURL=chunk-4UFH33GY.js.map
